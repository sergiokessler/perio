...
echo '<br>';
echo '<a href="' . $action1 . '" class="btn btn-primary" role="button">Editar ' . $this_table_label . '</a> ';
echo '<a href="' . $action2 . '" class="btn btn-warning" role="button">Eliminar ' . $this_table_label . '</a> ';
echo '<br>';
echo '<br>';
echo '</div>';
