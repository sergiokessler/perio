...
$zona = 'Nacional y Agencias';

include_once 'share/data_display.php';


// notas exclusivas de plan nacer
$sql = <<<END
    select 
        m.nombre,
        count(*) as cantidad,
...
echo '<h2>Notas en medios nacionales</h2>';
unset($params);
...
echo '<img src="share/chart_bar.php?params=' . params_encode($chart_params) . '">';
...
/*
echo '<h2>Notas sobre salud en general en medios nacionales</h2>';
unset($params);
